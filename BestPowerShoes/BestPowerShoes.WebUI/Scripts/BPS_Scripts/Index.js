        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                $.each(data.Processes, function (i, dd) {
                    ...
                    //if (processTbl == 0) {
                    //    $("#processTbl").append('<tr><td id="'+dd.ProcessId+'"><span class="glyphicon glyphicon-usd"></span><a href="Home/Process/' + dd.ProcessId + '">' + dd.ProcessName + '</a></td></tr>');
                    //}
                });
